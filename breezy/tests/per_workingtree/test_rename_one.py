...
class TestRenameOne(TestCaseWithWorkingTree):
    ...
    def test_rename_one_target_not_dir(self):
        ...
        self.assertRaises(
            errors.BzrMoveFailedError, tree.rename_one, "a", "not-a-dir/b"
        )
    ...
    def test_rename_one_non_existent(self):
        ...
        tree.commit("initial")
        self.assertRaises(
            errors.BzrMoveFailedError, tree.rename_one, "not-a-file", "a/failure"
        )
        self.assertRaises(
            errors.BzrMoveFailedError, tree.rename_one, "not-a-file", "also_not"
        )
    ...
    def test_rename_one_samedir(self):
        ...
        self.assertPathRelations(
            tree.basis_tree(), tree, [("", ""), ("b/", "b/"), ("foo", "a")]
        )
    ...
    def test_rename_one_not_localdir(self):
        ...
        self.assertPathRelations(
            tree.basis_tree(), tree, [("", ""), ("b/", "b/"), ("b/foo", "a")]
        )
    ...
    def test_rename_one_parent_dir(self):
        ...
        self.assertPathRelations(
            tree.basis_tree(), tree, [("", ""), ("a", "a"), ("b/", "b/"), ("d", "b/c")]
        )
    ...
    def test_rename_one_fail_consistent(self):
        ...
        self.assertPathRelations(
            tree.basis_tree(), tree, [("", ""), ("a", "a"), ("b/", "b/"), ("c", "c")]
        )
    ...
    def test_rename_one_after_dest_versioned(self):
        ...
        self.assertPathRelations(
            tree.basis_tree(), tree, [("", ""), ("a", "a"), ("b", None)]
        )
    ...
    def test_rename_one_after_with_after_dest_versioned(self):
        ...
        e = self.assertRaises(
            errors.BzrMoveFailedError, tree.rename_one, "a", "b", after=True
        )
        self.assertIsInstance(e.extra, errors.AlreadyVersionedError)
    ...
    def test_rename_one_after_no_target(self):
        ...
        # exception
        self.assertRaises(
            errors.BzrMoveFailedError, tree.rename_one, "a", "b/foo", after=True
        )
        self.assertPathRelations(
            tree.basis_tree(), tree, [("", ""), ("a", "a"), ("b/", "b/")]
        )
    ...
    def test_rename_one_after_source_and_dest(self):
        ...
        self.assertRaises(
            errors.RenameFailedFilesExist, tree.rename_one, "a", "b/foo", after=False
        )
        self.assertPathRelations(
            tree.basis_tree(), tree, [("", ""), ("a", "a"), ("b/", "b/")]
        )
