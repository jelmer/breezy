...
class TestConvenienceMakers(tests.TestCaseWithTransport):
    ...
    def test_make_tree_for_local_vfs_backed_transport(self):
        ...
        # Either the controldir keeps the decorator prefix (preferred), or
        # falls through to the underlying file:// — in both cases all three
        # controldirs should share the same local backing.
        root = tree.controldir.root_transport
        self.assertTrue(
            root.base.startswith("vfat+") or root.base.startswith("file://"),
            f"expected vfat+ or file:// prefix, got {root.base!r}",
        )
