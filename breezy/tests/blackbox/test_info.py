...
Repository:
         1 revision
""".format(format_description, datestring_first, datestring_first),
            out,
        )
        self.assertEqual("", err)
...
Repository:
         2 revisions
""".format(format_description, datestring_first, datestring_last),
            out,
        )
        self.assertEqual("", err)
...
""",
    ...
    def assertCheckoutStatusOutput(
        self,
        command_string,
        lco_tree,
        shared_repo=None,
...
""".format(
    ...
    def test_info_locking(self):
        ...
        repo = self.make_repository(
            "repo", shared=True, format=bzrdir.BzrDirMetaFormat1()
        )
        repo.set_make_working_trees(False)
        repo.controldir.root_transport.mkdir("branch")
