...
class ConvertBzrDir4To5(Converter):
    ...
    def _convert_working_inv(self):
        ...
        """
        from .xml4 import serializer_v4 as inventory_serializer_v4

        inv = inventory_serializer_v4.read_inventory(
            self.branch._transport.get("inventory")
        )
        f = BytesIO()
        from ...bzr.xml5 import serializer_v5 as inventory_serializer_v5
    ...
    def _write_all_revs(self):
        ...
        # TODO permissions
        from ...bzr.xml5 import serializer_v5 as revision_serializer_v5
